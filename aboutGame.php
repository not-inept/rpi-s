...
<html>
<head>
  <title>RPI Survival Game - About</title>
...
<body>
  ...
  <div id = "game">
    <h1>What is RPI Survival Game?</h1>
    <p>RPI S is primarily a text based, multiplayer survival/adventure online game. Set on the campus of Rensselear Polytechnic Institute, RPI S is designed to give players a sense of reality using real-world scenarios, but altered for a virtual environment. With an ever-changing list of fictitious events inspired by daily on-campus activities, RPI S offers something new each day for players.</p>

    <h2>Navigate Campus</h2>
